...
PYTHON_SENTENCES = (
    ...
    ("stale_check", "CHANGE_ABOUT_A_MISSING_DOCUMENT"),
    ("compose_proposal", "NO_PARTS_AT_ALL"),
    ("compose_proposal", "OUTSIDE_EVERY_PART"),
    ...
    ("join_flow", "ADDED_NOT_DIRECTLY_INSIDE"),
