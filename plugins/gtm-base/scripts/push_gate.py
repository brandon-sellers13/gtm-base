#!/usr/bin/env python3
"""Run the check that reads what a command would send before it runs.

The wrapper hands this script the request on standard input and the name of
the client as an argument. Everything it does lives in `gtmbase.gate`; this
file exists only to find the library and hand the arguments over.
"""
...
from gtmbase import gate  # noqa: E402
