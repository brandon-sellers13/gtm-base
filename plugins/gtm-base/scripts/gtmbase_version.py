#!/usr/bin/env python3
"""Print the version of the GTM Base library this script can reach.

This is the smallest possible script that uses the shim, and the test suite
runs it from three different folder layouts to prove the shim works.
"""
...
from gtmbase import __version__
