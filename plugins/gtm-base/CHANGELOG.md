...
- Astra's third look, on the twenty-third of September, found ten things that block the release and one that does not. Every one of them has a failing test first, built from Astra's own scenario, and everything from here to the end of this section is that round.
